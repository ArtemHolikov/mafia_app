...
export const useGameStore = create(
  persist(
    (set: any) => ({
      ...
      setDayTimerRunning: (running: boolean) =>
        set({ isDayTimerRunning: running }),
      ...
      resolveTieResolution: (decision: "leave" | "kick") =>
        set((state: any) => {
          ...
          if (
            result?.type !== "tieResolution" ||
            !Array.isArray(result.tiedIds)
          ) {
            return {};
          }
    ...
    }),
    {
      ...
      partialize: (state: any) => ({
        ...
        raisedForVotingPlayers: state.raisedForVotingPlayers,
        votingEntries: state.votingEntries,
        votingTie: state.votingTie,
        ...
        round: state.round,
        lastDoctorHealedPlayerId: state.lastDoctorHealedPlayerId,
        lastDoctorHealRound: state.lastDoctorHealRound,
